    ...
    ro: {
        ...
        footer: {
            ...
            items: {
                ...
                spiritual: 'Implicare Spirituală: Valori creștine, dialog sincer.',
                charity: 'Evenimente Caritabile: Concerte și strângeri de fonduri pentru cazuri grave.',
    ...
    ru: {
        ...
        footer: {
            ...
            items: {
                ...
                spiritual: 'Духовное участие: Христианские ценности, искренний диалог.',
                charity: 'Благотворительные мероприятия: Концерты и сбор средств для тяжелых случаев.',
